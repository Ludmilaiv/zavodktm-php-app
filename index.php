...
switch ($path) {
  ...
  case "/tg-unsubscribe":
	...
	case "/get-online":
		...
		break;
	case "/get-stat":
		require_once("./app/modules/app_get-stat.php");
		break;

	// Для админ панели
	case "/get-all-devices":
		require_once("./app/modules/admin_get-all-devices.php");
		break;
	case "/add-device-id":
		require_once("./app/modules/admin_add-id.php");
		break;
	case "/del-device-id":
		require_once("./app/modules/admin_del-id.php");
		break;
	case "/get-device-info":
		require_once("./app/modules/admin_get-device-info.php");
		break;
	default:
